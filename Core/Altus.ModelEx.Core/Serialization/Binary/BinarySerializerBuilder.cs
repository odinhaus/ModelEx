...
[assembly: Component(ComponentType = typeof(Altus.Core.Serialization.Binary.BinarySerializerBuilder))]
namespace Altus.Core.Serialization.Binary
{
    public class BinarySerializerBuilder : InitializableComponent, IComparer<MemberInfo>, IBinarySerializerBuilder
    {
                    ...
                    else if (mi.MemberType == MemberTypes.Property)
                    {
                            ...
                            && (gettor.IsFamily || gettor.IsPublic))
                        {
                            ...
                            if ((settor != null && (settor.IsFamily || settor.IsPublic))
                                ...
                                || (serializable != null && serializable.Length > 0 && ((BinarySerializableAttribute[])serializable)[0].SerializationType != null && ((BinarySerializableAttribute[])serializable)[0].SerializationType.Equals(typeof(IList<AbstractEntity>))))
                            {
                                if (serializable != null && serializable.Length > 0)
                                {
                                    if (((BinarySerializableAttribute)serializable[0]).SerializationType == null)
...
//#if(DEBUG)
            ...
            compilerParams.TempFiles = new TempFileCollection(directoryName, bool.Parse(Context.GetEnvironmentVariable("DebugInjections").ToString())); // change to true to load in VS debugger
//#else
...
namespace <Namespace>
{
    [System.CodeDom.Compiler.GeneratedCodeAttribute(""Connect"", ""1.0"")]
    [System.Serializable]
    public class BinarySerializer_<TypeName> : <QualifiedTypeName>, ISerializer<<QualifiedTypeName>>, IInitialize
    {       
...
<ReadValues>
        ...
        protected object DeserializeType(BinaryReader br)
        {
            ...
            {
                Type t = Altus.reflection.TypeHelper.GetType(tname);
                ...
                {
                    serializer = Altus.Instance.Shell.GetComponents<ISerializer>().Where(s
