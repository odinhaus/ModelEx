    ...
    public static class CSharpCompiler
    {
        ...
        public static Type Compile(string template, string typeName, string targetPath, string[] references, out bool hasErrors, out CompilerErrorCollection errors)
        {
            if (!Path.IsPathRooted(targetPath))
                targetPath = Path.Combine(Context.CurrentContext.Location, targetPath);
            ...
            bool debug = bool.Parse(Context.GetEnvironmentVariable("DebugInjections").ToString());
            ...
            compilerParams.ReferencedAssemblies.Add(new System.Uri(typeof(System.Windows.Clipboard).Assembly.Location).LocalPath);
            compilerParams.ReferencedAssemblies.Add(new System.Uri(typeof(System.Windows.Application).Assembly.Location).LocalPath);
            compilerParams.ReferencedAssemblies.Add(new System.Uri(typeof(System.IO.FileFormatException).Assembly.Location).LocalPath);
