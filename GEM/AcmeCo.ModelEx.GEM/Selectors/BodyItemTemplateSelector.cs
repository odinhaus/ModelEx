...
{
    public class BodyItemTemplateSelector : ViewTemplateSelector
    {
        public BodyItemTemplateSelector() { }
        ...
        public override System.Windows.DataTemplate SelectTemplate(object item, System.Windows.DependencyObject container)
        {
            if (item is ExplorerFile)
            {
                ...
                if (view is View)
                {
                    ((View)view).CurrentSize = "bodyItem";
                }
            ...
            else if (item is WPFView)
            {
                ...
                ((WPFView)item).CurrentSize = "bodyItem";
